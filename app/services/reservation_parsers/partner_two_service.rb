  ...
  class PartnerTwoService
    ...
    def format(data)
      { reservation: {
          ...
          security_price: BaseService.formatted_price(data.dig('reservation', 'listing_security_price_accurate')),
          payout_amount: BaseService.formatted_price(data.dig('reservation', 'expected_payout_amount')),
          total_paid: BaseService.formatted_price(data.dig('reservation', 'total_paid_amount_accurate')),
